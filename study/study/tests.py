...
class StudyTestCase(APITestCase):
    ...
    def test_create_study(self):
        ...
        response = self.client.post(reverse('study:study_create'), data=data)
    ...
    def test_retrieve_study(self):
        response = self.client.get(
            reverse('study:study_retrieve', kwargs={'pk': self.study.pk}),
        )
    ...
    def test_update_study(self):
        ...
        response = self.client.patch(
            reverse('study:study_update', kwargs={'pk': self.study.pk}),
    ...
    def test_delete_study(self):
        response = self.client.delete(
            reverse('study:study_delete', kwargs={'pk': self.study.pk}),
        )
